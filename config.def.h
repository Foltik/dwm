...
/* commands */
static char spawnmon[2] = "0"; /* currently selected monitor, updated in spawn() */
static const char *runcmd[] = { "rofi", "-m", spawnmon, "-show", "run" };
static const char *druncmd[] = { "rofi", "-m", spawnmon, "-show", "drun" };
